...
Version: 3.5.6 Timestamp: Tue Jul 5 19:44:32 EDT 2016
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "<button href='javascript:void(0)' class='select2-choice' tabindex='-1' aria-label='Select'>",
                ...
                "   </div>",
                "   <ul class='select2-results' aria-label='Results' role='listbox'>",
                "   </ul>",
                "</div>"].join(""));
            return container;
        },
        ...
        initContainer: function () {
            ...
            if (originalTitle || elementLabel.text()) {
        ...
        createChoice: function (data) {
            var enableChoice = !data.locked,
                enabledItem = $(
                    ...
                    "    <div></div>" +
                    "    <button class='select2-search-choice-close' tabindex='-1' aria-label='X'></button>" +
                    "</li>"),
                disabledItem = $(
